...
export const menus = {
    add_account: {
        add_account_coral: 'Nintendo Switch Onlineアカウントを追加',
        add_account_moon: 'Nintendo みまもり Switchアカウントを追加',
    },
...
export const main_window = {
    ...
    update: {
        update_available: 'アップデートが利用可能です：{{name}}',
        download: 'ダウンロード',
    ...
    main_section: {
        ...
        moon_only_user: {
            title: 'Nintendo Switch Online',
            desc_1: 'このユーザーはNintendo Switch Onlineのアプリではなく、Nintendo みまもり Switchのアプリにサインインしています。',
            desc_2: '詳細を確認するには、こちらからNintendo Switch Onlineのアプリにログインするか、nxapiのコマンドを使ってNintendo みまもり Switchのデータを閲覧してください。',
            login: 'ログイン',
        },
    ...
    discord_section: {
        ...
        active_friend: 'このアカウントを使って<0></0>の情報をDiscordで表示',
        active_unknown: 'このアカウントを使って、不明なユーザーの情報がDiscordで表示されます。',
...
export const discordsetup_window = {
    ...
    coral_user_heading: '②ユーザーを選択',
    coral_user_help: 'このユーザーは、プレイ情報を共有するユーザーとフレンド同士である必要があります。',
    coral_friend_heading: '③フレンドを選択',
    coral_friend_help: 'このユーザーのプレイ情報を共有します。',

    url_heading: '②プレイ情報URLを入力',
    url_help: 'このURLは、ユーザー、フレンド、プレゼンスキーのいずれかを含んだJSONファイルを返すHTTPSのURLでなければなりません。このオプションはnxapiのzncAPIプロキシを使うことを想定しています。',
